# 탐정 진구지 사부로: 꿈의 끝에서 — 한국어 패치 v0.8.0

Sega Saturn 일본판의 비공식 한국어 패치입니다. 원본 게임은 포함하지 않으며, 아래 SHA-256과 일치하는 원본 BIN이 필요합니다.

**[v0.8.0 패치 다운로드](https://github.com/lf-idonotknow/Jinguuji-Yume-Saturn-Korean-Patch/releases/tag/v0.8.0)**

릴리스의 **Assets**에서 `Jinguuji-Yume-Saturn-Korean-Patch-v0.8.0.zip`을 받으세요. GitHub가 자동으로 표시하는 `Source code (zip)`은 패치가 아닙니다.
...
5. **XDelta patch**에 동봉한 `Jinguuji-Yume-Saturn-Korean-Patch-v0.8.0.xdelta`를 선택합니다.
...
10. 아래 적용 후 해시와 일치하는지 확인한 뒤, 에뮬레이터에서 **동봉된 CUE**를 선택해 실행합니다.
...
**패치 적용 후 BIN — 793,254,336바이트**

```text
e8220fa6f6d5d5518979e3aa2cea377b6b8c2e6483264742e3dcfd02ecfa2696
```

**동봉 CUE — SHA-256**

```text
e18a003a36357f0de6d14cfd216cb6fbe53a34d39a242cbc2453e4a695b5d4ce
```
...
**이 버전은 검수 중인 프리릴리스입니다.** 모든 문구·루트의 검수가 완료된 최종판을 뜻하지 않습니다. 최신 테이프 자막과 추적 영상 자막의 실제 재생·동기 검증도 남아 있습니다.
